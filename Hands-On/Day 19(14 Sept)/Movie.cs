...
namespace Handson
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Vikram", "Tamil", "Action", 60));
            movies.Add(new Movie("KGF2", "Kannada", "Action", 50));
            movies.Add(new Movie("Arundhathi", "Telugu", "Horror", 20));
            movies.Add(new Movie("Premam", "Malayalam", "Romance", 40));
            movies.Add(new Movie("Dia", "Kannada", "Romance", 30));
        }
        public void search()
        {
