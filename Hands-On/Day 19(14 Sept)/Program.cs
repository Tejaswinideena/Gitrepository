...
namespace Sept14
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            s2.validate();
            FileStream fs = new FileStream(@"hello.bin", FileMode.Create, FileAccess.Write);
            ...
            fs.Close();
            fs.Dispose();
            FileStream fs1 = new FileStream(@"hello.bin", FileMode.Open, FileAccess.Read);
            ...
            si1.DisplayMovies();
            si1.search();
            FileStream fs2 = new FileStream(@"hello1.bin", FileMode.Create, FileAccess.Write);
            BinaryFormatter write = new BinaryFormatter();
            write.Serialize(fs2, si1);
            fs2.Flush();
            fs2.Close();
            fs2.Dispose();
            FileStream fs3 = new FileStream(@"hello1.bin", FileMode.Open, FileAccess.Read);
        ...
        mov:
            ...
            FileStream fs7 = new FileStream(@"hello2.json", FileMode.Create, FileAccess.Write);
            ...
            fs7.Close();
            fs7.Dispose();
            FileStream fs8 = new FileStream(@"hello2.json", FileMode.Open, FileAccess.Read);
            ...
            s1.alreadyseen = dgg;
            FileStream fs4 = new FileStream(@"hello3.Xml", FileMode.Create, FileAccess.Write);
            System.Xml.Serialization.XmlSerializer xm = new System.Xml.Serialization.XmlSerializer(typeof(CustomerUser));
            xm.Serialize(fs4, s1);
            fs4.Flush();
            fs4.Close();
            fs4.Dispose();
            FileStream fs5 = new FileStream(@"hello3.Xml", FileMode.Open, FileAccess.Read);
            ...
            FileStream fs9 = new FileStream(@"hello4.bin", FileMode.Create, FileAccess.Write);
            BinaryFormatter write1 = new BinaryFormatter();
            write1.Serialize(fs9, e1);
            fs9.Flush();
            fs9.Close();
            fs9.Dispose();
            FileStream fs81 = new FileStream(@"hello4.bin", FileMode.Open, FileAccess.Read);
